...
import static com.nhom4.orderfoodserver.Common.Common.PICK_IMAGE_REQUEST;
...
import com.nhom4.orderfoodserver.Model.Category;
import com.nhom4.orderfoodserver.Service.ListenOrder;
import com.nhom4.orderfoodserver.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    private void showDialog() {
        ...
        alertDialog.setTitle("Thêm mới mục thực phẩm");
        ...
        alertDialog.setPositiveButton("CÓ", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (newCategory!=null){
                    ...
                    Snackbar.make(drawer,"Thực phẩm mới"+newCategory.getName()+"đã thêm xong",Snackbar.LENGTH_SHORT).show();
                }
    ...
    private void showUpdateDialog(final String key, final Category item) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Home.this);
        alertDialog.setTitle("Sửa mục thực phẩm");
        alertDialog.setMessage("Hãy điền đầy đủ thông tin");
